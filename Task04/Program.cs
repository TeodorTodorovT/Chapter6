...
namespace Task04
{
    class Program
    {
        ...
        {   //task: Write a program that prints all possible cards from a standard deck of cards, without jokers (there are 52 cards: 4 suits of 13 cards).
            for (int i = 0; i < 4; i++)
            {
                ...
                for (int j = 0; j < 13; j++)
                {
                    switch (i)
                    {
                        case 0: Console.Write("Hearts ");
                            break;
                        case 1: Console.Write("Diamonds ");
                            break;
                        case 2: Console.Write("Spades ");
                            break;
